# REFRESH DIRECTIVE — 22INR0267 Shaula II Solar (user-ordered deep scan, 2026-07-21)

Pre-computed systematic leads. Read FIRST, do not redo these lookups blind.

## Queue facts (2026-06-01 snapshot, authoritative)
- Shaula II Solar, DeWitt County, 205.2 MW SOL/PV, zone SOUTH.
- SPV/interconnecting entity: **Shaula Energy Project II, LLC**.
- POI: **tap 345kV 5133 Elm Creek - 5915 SO TEX ckt 1** (Elm Creek→South Texas Project corridor).
- IA signed 2022-04-27; financial security + NTP: Yes; **projectCod 2026-05-30 — ALREADY PASSED**, constructionStart empty.
...
22INR0251 Shaula I Solar (research/22INR0251_shaula-i-solar/) is the sibling: SAME county, SAME POI, SAME 205.2 MW. Any footprint/filing/news you find
...
1. **PUCT rung-0**: puct_inr_join.json has ZERO items for this INR (filed IA may be image-only or
   ...
   → Run `puct.py match 22INR0267 --dir <sources/> --key "Shaula Energy Project"` and pull all 4; verify INR-in-PDF.
